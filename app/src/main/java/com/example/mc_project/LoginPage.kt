...
class LoginPage : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var tastePlaceArr = mutableListOf(
            ...
            TastePlace(userId = 2, type = "식당", longitude = 127.0588583663039, latitude = 37.5109095881113,
                name = "삼겹베네 ", rate = 3.5, content = "적당히 맛있었던 것 같아. 한번 쯤은 추천"),
            TastePlace(userId = 2, type = "식당", longitude = 127.07693931122469, latitude = 37.50433469932041,
                name = "맥도날드 ", rate = 3.5, content = "적당히 맛있었던 것 같아. 한번 쯤은 추천"),
